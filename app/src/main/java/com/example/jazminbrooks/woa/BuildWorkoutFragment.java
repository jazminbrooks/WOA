...
public class BuildWorkoutFragment extends Fragment {
    ...
    public static BuildWorkoutFragment newInstance(int columnCount) {
        BuildWorkoutFragment fragment = new BuildWorkoutFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view instanceof RecyclerView) {
            ...
            recyclerView.setAdapter(new BuildWorkoutRecyclerViewAdapter(ExerciseContent.ITEMS, mListener));
